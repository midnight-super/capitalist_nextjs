...
const TableHeader = ({ data, filter: _filter, handleAddOpen, searchQuery, setSearchQuery }) => {
  ...
  useEffect(() => {
    if (isInitialLoad) {
      ...
      _filter &&
        _filter({
          taskTypeName: { value: initialFilters.taskTypeName, mode: filterModes.taskTypeName },
  ...
  const submitData = (data) => {
    const appliedFilters = {
      taskTypeName: { value: data.taskTypeName, mode: filterModes.taskTypeName },
  ...
  const clearSpecificFilter = (filterKey) => {
    setFilters((prevFilters) => {
      ...
      const appliedFilters = {
        taskTypeName: { value: updatedFilters.taskTypeName, mode: filterModes.taskTypeName },
