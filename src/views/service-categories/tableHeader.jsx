...
const TableHeader = ({ data, categoryFilter, handleAddOpen, searchQuery, setSearchQuery }) => {
  const {
  ...
  const [filterModes, setFilterModes] = useState({
    ...
    parentServiceCategoryName: 'EQUAL',
    createdAt: 'EQUAL',
    updatedAt: 'EQUAL',
  })
    ...
    if (isInitialLoad) {
      ...
      categoryFilter &&
        categoryFilter({
          ...
          parentServiceCategoryName: {
            value: initialFilters.parentServiceCategoryName,
            mode: filterModes.parentServiceCategoryName,
          },
  ...
  }, [isInitialLoad, categoryFilter, filters, filterModes])
  ...
  const submitData = (data) => {
    const appliedFilters = {
      ...
      parentServiceCategoryName: { value: data.parentServiceCategoryName, mode: filterModes.parentServiceCategoryName },
    ...
    categoryFilter && categoryFilter(appliedFilters)
    setFilters(data)
    handlePopoverClose()
  }
  ...
  const clearFilter = () => {
    ...
    setValue('parentServiceCategoryName', '')
    setValue('createdAt', '')
    setValue('updatedAt', '')
    setFilters({
      serviceCategoryName: '',
  ...
  const clearSpecificFilter = (filterKey) => {
    setFilters((prevFilters) => {
      ...
      const appliedFilters = {
        ...
        parentServiceCategoryName: {
          value: updatedFilters.parentServiceCategoryName,
          mode: filterModes.parentServiceCategoryName,
        },
  ...
  const filterFields = [
    { title: 'Name', value: 'serviceCategoryName' },
    { title: 'Service', value: 'parentServiceCategoryName' },
